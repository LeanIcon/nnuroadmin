...
export class LayoutConfig {
	public defaults: LayoutConfigModel = {
		...
		self: {
			...
			logo: {
				dark: './assets/media/logos/logo-mini-4.png',
				light: './assets/media/logos/logo-mini-4.png',
				brand: './assets/media/logos/logo-mini-4.png',
				green: './assets/media/logos/logo-mini-4.png',
			},
		},
		...
		loader: {
			enabled: true,
			type: 'spinner-logo',
			logo: './assets/media/logos/logo-mini-4.png',
